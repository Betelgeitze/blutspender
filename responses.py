responses = {
    "de": {
        ...
        "del_example": "Wenn du deine Postleitzahl löschen willst, schreibe es in diesem Format:\n\n"
                       ...
                       "Zum Beispiel:\n"
                       "delete: 13450\n\n"
                       "Wenn du alle Postleitzahlen löschen willst, schreibe:\n"
                       "delete: all",
        ...
        "failed_del": "Wenn du deine Postleitzahl löschen willst, schreibe es in diesem Format:\n\n"
                      ...
                      "Zum Beispiel:\n"
                      "delete: 13450",
        "reset": "Du hast keine Postleitzahlen mehr. Lass uns vom Anfang starten!",
        "add_or_del": "Wenn du deine Daten ergänzen oder löschen willst, schreibe /start",
        ...
        "available_termine": "Danke, hier sind alle Termine in deiner Nähe für die Woche. "
                             "In der Zukunft informiere ich dich, falls noch etwas auftaucht!",
        "no_termine": "Es gibt keine Termine in deiner Nähe für diese Woche. Ich informiere dich, wenn etwas auftaucht.\n\n"
                      "Du musst nichts mehr machen. Danke!\n\n"
                      "Wenn du deine Daten ergänzen oder löschen willst, schreibe /start",
    ...
    "en": {
        ...
        "available_appointments": "Thanks, here are all the appointments near you for the week. "
                             "In the future, I'll let you know if anything else comes up!",
        "no_termine": "There are no appointments near you for this week. I'll let you know if anything comes up."
                      ...
                      "If you want to add or delete your dates, write /start",
